// Program za množenje matrik s Strassenovim algoritmom.
...
public class Izziv6 {
	public static void main(String[] args) {
        ...
        System.out.println(a.multStrassen(b, cutoff));
	}
}